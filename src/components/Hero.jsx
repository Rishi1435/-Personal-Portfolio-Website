...
const Hero = () => {
  return (
    ...
    >
      {/* Corner Glow Effects */}
      <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vh] bg-[radial-gradient(circle,color-mix(in_srgb,var(--color-accent)_12%,transparent)_0%,transparent_60%)] pointer-events-none z-0 animate-[pulse_6s_ease-in-out_infinite]" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vh] bg-[radial-gradient(circle,color-mix(in_srgb,var(--color-accent)_12%,transparent)_0%,transparent_60%)] pointer-events-none z-0 animate-[pulse_6s_ease-in-out_infinite_delay-2s]" />
      ...
      <div className="container max-w-[1280px] mx-auto px-4 sm:px-6 md:px-12 relative z-10 w-full">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-4 gap-6 lg:gap-8 items-center w-full">
          ...
          >
            <div className="w-full bg-[#080808]/75 backdrop-blur-md border border-[rgba(255,255,255,0.06)] rounded-xl p-5 shadow-[0_4px_30px_rgba(0,0,0,0.8)] relative overflow-hidden group hover:border-[color-mix(in_srgb,var(--color-accent)_30%,transparent)] transition-all duration-300">
              ...
              >
                <picture className="h-full w-auto flex items-end justify-center">
                  ...
                  <img
                    ...
                    fetchPriority="high"
                    decoding="async"
                    className="h-full w-auto object-contain drop-shadow-[0_0_35px_color-mix(in_srgb,var(--color-accent)_25%,transparent)]"
                    style={{
